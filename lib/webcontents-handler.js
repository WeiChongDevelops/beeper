...
function onLinkContextMenu(ev, params, webContents) {
    ...
    if (!url.startsWith("blob:")) {
        ...
        if (url.startsWith(MAILTO_PREFIX)) {
            ...
            popupMenu.append(new electron_1.MenuItem({
                label: (0, language_helper_1._t)("Copy link address"),
                accelerator: "a",
                click() {
            ...
            async click() {
                ...
                try {
                    if (url.startsWith("data:")) {
                        await writeNativeImage(filePath, electron_1.nativeImage.createFromDataURL(url));
                    }
                    else {
...
electron_1.ipcMain.on("userDownloadOpen", function (ev, { path }) {
    electron_1.shell.openPath(path);
});
electron_1.ipcMain.on("showInFinder", function (ev, path) {
...
exports.default = (webContents) => {
    ...
    webContents.on(
    // @ts-ignore no this is real
    "will-navigate", (ev, target) => {
...
//# sourceMappingURL=webcontents-handler.js.map